...
function tampilbuku()
{
    ...
    if(!empty($result)){
        foreach ($result as $buku) {
            ...
            echo "<td>"."<a href='FormBuku.php?id_buku=".$buku['id_buku']." '><button class=edit>Edit</button></a>";
            echo "<a href='Buku.php?id_buku=" . $buku['id_buku'] . " ' onclick=\"return confirm('Lanjut Hapus?')\"><button class=hapus>Hapus</button></a> </td>";
            echo "</tr>";
        }
    }
}
...
function tampilmember()
{
    ...
    if(!empty($result)){
        foreach ($result as $member) {
            ...
            echo "<td>"."<a href='FormMember.php?id_member=".$member['id_member']." '><button class=edit>Edit</button></a>";
            echo "<a href='Member.php?id_member=" . $member['id_member'] . " ' onclick=\"return confirm('Lanjut Hapus?')\"><button class=hapus>Hapus</button></a> </td>";
            echo "</tr>";
        }
    }
}
...
function tampilpeminjaman()
{
    ...
    if(!empty($result)){
        foreach ($result as $peminjaman) {
            ...
            echo "<td>"."<a href='FormPeminjaman.php?id_peminjaman=".$peminjaman['id_peminjaman']." '><button class=edit>Edit</button></a>";
            echo "<a href='Peminjaman.php?id_peminjaman=" . $peminjaman['id_peminjaman'] . " ' onclick=\"return confirm('Lanjut Hapus?')\"><button class=hapus>Hapus</button></a> </td>";
            echo "</tr>";
        }
    }
}
